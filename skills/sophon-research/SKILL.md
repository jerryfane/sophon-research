...
Prefer the local `sophon-research` CLI. Sophon is read-only, unauthenticated,
and should be queried through its API/text endpoints rather than scraped pages.
